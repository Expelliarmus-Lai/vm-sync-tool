...
TRANSLATIONS = {
    "zh": {
        ...
        "sync.host_baseline_start": "正在建立 Host 文件基线，工程较大时会稍慢；完成后开始监听。",
        ...
        "ui.start.checking": "正在启动: 已保存配置，正在后台检查 VM 和 .bin 输出...",
    ...
    "en": {
        ...
        "sync.host_baseline_start": "Building the Host file baseline. Large projects can take a moment; watching starts after this finishes.",
        ...
        "ui.start.checking": "Starting: config saved, checking VM and .bin output in the background...",
